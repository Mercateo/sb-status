...
public class SpringBootProcessStatus {
    ...
    private static String jmxConnect(VirtualMachine vm) throws IOException,
    ...
    private static String getLocalConnector(VirtualMachine vm)
            throws IOException {
        return vm.getAgentProperties().getProperty(
    ...
    private static String findToolsJar() {
        ...
        String homeLib = System.getProperty("java.home") + File.separator
                + ".." + File.separator + "lib" + File.separator + "tools.jar";
        if (checkFileExists(homeLib)) {
            return homeLib;
        }

        String jreLib = System.getProperty("java.home") + File.separator
                + "lib" + File.separator + "tools.jar";
        if (checkFileExists(jreLib)) {
            return jreLib;
        }

        String fruitLib = System.getProperty("java.home") + File.separator
    ...
    private static StatusCmdLine parseCommandLine(
            CmdReader<StatusCmdLine> reader, String[] args) {
